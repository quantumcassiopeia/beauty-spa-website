...
export function FlatCard({
  ...
  return (
    <div className="bg-[#f4f0e7] flex gap-4 h-28 w-80 md:flex-col md:h-80 md:w-44 rounded-2xl md:bg-transparent  ">
      ...
      <div className="relative flex flex-col justify-between py-3 md:py-0">
        ...
        <h3 className=" text-2xl md:text-3xl md:text-center text-[var(--darker-base-color)]">
          {title}
        </h3>
      </div>
    </div>
